...
local predicate_names = ["text_dob", "text_dod", "text_occupation", "text_field", "text_invent", "text_used_o", "text_used_f", "text_founded", "text_inventor", "text_usedin", "text_contains", "kb_studied_f", "kb_graduate_o", "kb_isa"];
local theories = [all_theories[4]];
